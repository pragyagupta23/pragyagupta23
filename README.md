...
### 🔭 Currently
- Building out authentication (Spring Security + JWT) for my Journal App
- Strengthening my DSA fundamentals
- Open to **Software Developer/ Java Developer/ Bckend Developer** roles

### 🌱 Background
- B.Tech in Electronics & Communication Engineering, Rajasthan Technical University — CGPA 9.29/10
- Completed *Java & Data Structures & Algorithms* (Apna College) and *Generative AI Career Essentials* (Microsoft & LinkedIn)
- Frontend Web Developer Intern at Bit to Byte Robotics
...
<sub>⭐️ from [pragyagupta23](https://github.com/pragyagupta23)</sub>
